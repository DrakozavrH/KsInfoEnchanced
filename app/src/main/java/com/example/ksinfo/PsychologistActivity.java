...
public class PsychologistActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final DrawerLayout drawerLayout = findViewById(R.id.PsychologistDrawerLayout);
    ...
    private void rightMenuDialog(){
        ...
        builder.setTitle("Меню").setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    case 0: {
                        Intent intent = new Intent(PsychologistActivity.this, SettingsActivity.class);
                        startActivity(intent);
                    }break;
                    case 1:{
                        Intent intent = new Intent(PsychologistActivity.this, LoginActivity.class);
                        startActivity(intent);
                    }break;
                    default:
