...
public class MyDocumentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final DrawerLayout drawerLayout = findViewById(R.id.MyDocumentsDrawerLayout);
    ...
    private void rightMenuDialog(){
        ...
        builder.setTitle("Меню").setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    case 0: {
                        Intent intent = new Intent(MyDocumentsActivity.this, SettingsActivity.class);
                        startActivity(intent);
                    }break;
                    case 1:{
                        Intent intent = new Intent(MyDocumentsActivity.this, LoginActivity.class);
                        startActivity(intent);
                    }break;
                    default:
